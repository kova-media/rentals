      ...
      <header className="site-header">
        <div className="container header-inner">
          ...
          <nav>
            ...
            <a className="button button-dark button-small" href="/signin">Sign In</a>
          </nav>
        </div>
      </header>
      <section className="hero">
        <div className="container hero-inner">
          <div className="hero-copy">
            <p className="eyebrow">Rentals, simplified</p>
            <h1>Find a rental.<br />Skip the clutter.</h1>
            <p className="lede">Straightforward listings with the information that actually matters.</p>
          </div>
          <form className="search-panel" action="/rentals">
            <label htmlFor="location">Where do you want to live?</label>
            <div className="search-row">
              <input id="location" name="location" placeholder="City or ZIP code" />
      ...
      <section className="browse-section" id="browse">
        <div className="container">
          <div className="section-header">
            <div><p className="eyebrow">Available now</p><h2>Latest rentals</h2></div>
            <a className="text-link" href="/rentals">View all rentals</a>
          </div>
          <div className="listing-grid">
            {listings.map((listing) => (
              <a className="listing-card" href="/rentals/example" key={listing.city}>
                <div className="listing-image"><img src={listing.image} alt="" /></div>
                <div className="listing-content">
                  <div className="price">{listing.price}<span>/month</span></div>
                  <div className="details">{listing.beds} bed <span>·</span> {listing.baths} bath <span>·</span> {listing.type}</div>
      ...
      <section className="landlord-section" id="landlords">
        <div className="container landlord-panel">
          <div>
            ...
            <h2>List your property without building a listing.</h2>
            <p className="landlord-copy">You provide the details. We keep every rental clean, consistent, and easy to compare.</p>
          </div>
          <a className="button button-dark" href="/landlord/signup">List a property</a>
        </div>
      </section>
